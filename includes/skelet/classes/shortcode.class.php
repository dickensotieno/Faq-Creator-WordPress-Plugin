  ...
  class SkeletFramework_Shortcode_Manager extends SkeletFramework_Abstract{
    ...
    public function media_shortcode_button( $editor_id ) {
      ...
      if( ! in_array( $post_type, $this->exclude_post_types ) ) {
        echo '<a href="#" class="button button-primary sk-shortcode" data-editor-id="'. $editor_id .'">'. __( 'Add Faq Shortcode', SK_TEXTDOMAIN ) .'</a>';
      }
    ...
    ?>
      <div id="sk-shortcode-dialog" class="sk-dialog" title="<?php _e( 'Add Faq Shortcode', SK_TEXTDOMAIN ); ?>">
