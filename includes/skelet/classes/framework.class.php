    ...
    public function admin_page() {
      ...
      echo '<div class="sk-framework sk-option-framework">';
        ...
        echo sprintf('%s',
            ...
            //$this->settings['header_title']." <small>".$this->settings['current_version']."</small>":"Skelet Framework <small>by DickensAyieko</small>"); 
            $this->settings['header_title']:"Skelet Framework"); 
        echo '</h1>';
        echo '<p class="feedback"><a target="_blank" href="http://dickensayieko.co/feedback/">Feedback</a></p>';
        echo '<fieldset>';
      ...
      echo '<footer class="sk-footer">';
        ...
        echo '<a target="_blank" href="http://dickensayieko.co/"><img src="' . $skelet_path["uri"] . '/assets/images/pressapps.png"></a>';
