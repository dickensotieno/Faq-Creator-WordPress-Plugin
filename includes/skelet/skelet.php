 ...
 * Skelet Framework
 * @version 1.0.3 
 * @author AdonCreatives <hi@dickensayieko.co>
 * 
 */
...
/**
 * Add AdonCreatives Menu
 */
if(!class_exists("Skelet_AdonCreatives_Menu")){

  class Skelet_AdonCreatives_Menu{

    public static function pa_main_menu(){
        global $skelet_paths, $submenu;
      
        call_user_func("add_submenu_page", SK_PARENT_MENU, "Products", "Products", "manage_options", "dickensos-product", array("Skelet_AdonCreatives_Menu","get_pa_general_pages"));
        //call_user_func("add_submenu_page", SK_PARENT_MENU, "Help", "Help", "manage_options", "pressapps-help", array("Skelet_AdonCreatives_Menu","get_pa_general_pages"));
                          
   }
    public static function get_pa_general_pages(){
      if(!class_exists("AdonCreatives"))
      {
            include_once wp_normalize_path(plugin_dir_path(__FILE__ ) .'/dickensos/dickensos.class.php');
            $pa = new AdonCreatives;
            $route_param = isset( $_GET["page"] )  ? $_GET["page"] : "";
            //Line 222 is for PHP 5.2 and below, uncomment it if your running PHP 5.2 and below
            //call_user_func( 'AdonCreatives::route', $route_param );
     ...
     add_action("admin_menu",array("Skelet_AdonCreatives_Menu","pa_main_menu"),999);
